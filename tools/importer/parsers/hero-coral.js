...
/* global WebImporter */
/**
 * Parser for hero-coral. Base: hero.
 ...
 *   Row 3: title (heading), subheading, and optional CTA links.
 */
export default function parse(element, { document }) {
  ...
  const block = WebImporter.Blocks.createBlock(document, { name: 'hero-coral', cells });
