...
/**
 * Transformer: mandg Dynamic Media / Scene7 images.
 * Source contains Scene7 IS/Image URLs (assets.mandg.com/is/image/...).
 * Rewrites DM <img> tags into anchors that round-trip through markdown; a
 * companion auto-block in scripts/scripts.js rebuilds responsive <picture>
 * elements at render time. Runs in afterTransform only — block parsers run
 * between the hooks and need <img> to build their cells.
 * See dm-scene7-transformer.md (canonical spec).
 */
